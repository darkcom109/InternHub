"""
Django settings for internhub_project project.
...
SECRET_KEY = 'django-insecure-%_w_^15@^v$v2(gdeg7-28m0!@)#3anq))xr-&y!)7rz&$#5q*'
...
WSGI_APPLICATION = 'internhub_project.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'myproject_db',  # the name you just created
        'USER': 'postgres',
